...
- Voxels spawn/despawn based on field threshold — with a feedback loop: existing voxels lower the threshold by 20% (hysteresis)
...
- Camera-facing face culling via dot product test — cuts rendered geometry by ~80%
